...
STFC's budget for multidisciplinary facilities (Diamond Light Source, the ISIS Neutron and Muon Source, and the Central Laser Facility) will fall by 15% over four years. 
The cuts outlined by STFC mean reducing the number of experiments that can be conducted at ISIS by 200 per year, potentially closing our world-leading muon beamlines and Lasers for Science Facility, and gateway reviews in 2027–2028 that could close a whole facility if savings targets are missed.

### Why this matters for growth, not just science

These facilities are industrial infrastructure, not just academic assets, and cutting them undercuts the government's own Industrial Strategy:

* **Life sciences**: Diamond's beamlines are used routinely by pharma/biotech for drug discovery — core to the Life Sciences Sector Plan.
* **Advanced manufacturing**: ISIS and the Central Laser Facility support materials, alloy and battery R&D central to the Advanced Manufacturing Sector Plan.
* **Clean energy**: The same capability underpins battery and hydrogen R&D under the Clean Energy Industries Sector Plan.

Cutting access and support while asking these sectors to invest more sends a mixed signal.
...
Thank you for representing [constituency name] on this.
